    ...
    <div class="container">
        ...
        <form action="viewappointment">
            <div class="user_details">
                <div class="input_pox">
                    <span class="datails">Patient_Name</span>
                    <input type="text" placeholder="Enter Patient Name" name="uname" required>
                </div>
                <div class="input_pox">
                    <span class="datails">Age</span>
                    <input type="number" placeholder="Enter Patient Age" name="age" required>
                </div>
                <div class="input_pox">
                    <span class="datails">Email</span>
                    <input type="text" placeholder="Enter Patient Email" name="email" required>
                </div>
                <div class="input_pox">
                    <span class="datails">Phone Number</span>
                    <input type="number"  placeholder="Enter Patient Phone" name="phone" min="1" max="100000000000"  required>
                </div>
                <div class="input_pox">
                    <span class="datails">Doctor_Name</span>
                    <input type="text" placeholder="Enter Doctor Name" name="dname"  required>
                </div>
                <div class="input_pox">
                    <span class="datails">Date</span>
            ...
            <div class="button">
                <input type="submit" value="BookAppointement">
            </div>
        </form>
    </div>
</body>
