...
<body class="login-page">
    <div class="login-box">
        ...
        <form action="doctorlogin" method="post">
            <div class="user-box">
                <input class="user-box-input" type="text" name="dname" required>
                <label class="user-box-label">Username</label>
            </div>
            <div class="user-box">
                <input class="user-box-input" type="password" name="dpass" required>
                <label class="user-box-label">Password</label>
            </div>
            <input type="submit" class="login-box-button" >
